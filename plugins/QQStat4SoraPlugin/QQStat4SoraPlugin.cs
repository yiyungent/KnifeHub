...
{
    public class QQStat4SoraPlugin : BasePlugin, PluginCore.IPlugins.ISoraPlugin, ITimeJobPlugin
    {
        /// <summary>
        /// 43200 = 12 小时
        /// </summary>
        ...
        public void SendCalendar((Bot s, GroupMessageEvent e) obj, string message, uint groupUin, uint memberUin, SettingsModel settingsModel)
        {
            ...
            // 下方获取当前群聊
            //string urlParam = $"{settingsModel.BaseUrl}/Plugins/QQStat4SoraPlugin/Calendar?groupUin={groupUin.ToString()}";
            string urlParam = $"{settingsModel.BaseUrl}/Plugins/QQStat4SoraPlugin/Calendar";
        ...
        public void SendStackedArea((Bot s, GroupMessageEvent e) obj, string message, uint groupUin, SettingsModel settingsModel, uint memberUin = 0)
        {
            ...
            // 下方获取当前群聊
            //string urlParam = $"{settingsModel.BaseUrl}/Plugins/QQStat4SoraPlugin/StackedArea?groupUin={groupUin.ToString()}";
            string urlParam = $"{settingsModel.BaseUrl}/Plugins/QQStat4SoraPlugin/StackedArea";
