...
namespace MemosPlusPlugin.Controllers
{
    /// <summary>
    ...
    /// </summary>
    [Route($"Plugins/{(nameof(MemosPlusPlugin))}")]
    public class HomeController : Controller
    {
        public async Task<ActionResult> Get()
        {
            string indexFilePath = System.IO.Path.Combine(PluginPathProvider.PluginWwwRootDir(nameof(MemosPlusPlugin)), "index.html");
