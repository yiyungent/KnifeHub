...
namespace QQNotePlugin.Controllers
{
    /// <summary>
    ...
    /// </summary>
    [Route($"Plugins/{(nameof(QQNotePlugin))}")]
    public class HomeController : Controller
    {
        public async Task<ActionResult> Get()
        {
            string indexFilePath = System.IO.Path.Combine(PluginPathProvider.PluginWwwRootDir(nameof(QQNotePlugin)), "index.html");
